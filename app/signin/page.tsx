    ...
    try {
      await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          queryParams: {
            hd: "study.iitm.ac.in", // IIT Madras restriction
          },
        },
      })
    } catch (error) {
      console.error("Google Sign-In failed:", error)
      alert("Sign in failed. Please use your IIT Madras email.")
    }
  }
          ...
          <div className="glass-dark p-8 rounded-2xl border border-primary/30 hover:border-primary/60 transition-all duration-300">
            ...
            <div className="space-y-6">
              ...
              <p className="text-center text-white/50 text-xs">
                Use your <span className="font-semibold">study.iitm.ac.in</span> account
              </p>
            </div>
